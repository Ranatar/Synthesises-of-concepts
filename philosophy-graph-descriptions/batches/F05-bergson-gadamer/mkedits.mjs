...
//   node batches/F05-bergson-gadamer/mkedits.mjs
...
fs.writeFileSync('edits/batch-F05-bergson-gadamer.json', JSON.stringify({meta: {
  batch: 'F05',
  title: 'Описания философов: Бергсон — Гадамер',
