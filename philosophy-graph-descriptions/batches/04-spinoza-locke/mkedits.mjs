...
const FL = JSON.parse(fs.readFileSync('batch04-flags.json','utf8'));
...
fs.writeFileSync('edits/batch-04-spinoza-locke.json', JSON.stringify({meta:{batch:'04',
  title:'Внутрисистемные связи: Спиноза, Локк',
  spec:'descriptions-revision-spec.md',specRevision:3,target:'philosophy_graph.html',
  targetMd5:'565c165c4ea016a9d51300bcac961a23',created:'2026-08-09',layer:'inner',
