...
fs.writeFileSync('edits/batch-C05-foucault-rorty.json', JSON.stringify({meta:{batch:'C05',
 title:'Поправка строя fix-описаний: принимающие системы Фуко, Деррида, Рорти',
 spec:'descriptions-revision-spec.md', specRevision:4, target:'philosophy_graph.html',
 targetMd5:'74dce1fb3920d14aeae4a905df7cc02c', created:'2026-08-11', layer:'cross-correction',
