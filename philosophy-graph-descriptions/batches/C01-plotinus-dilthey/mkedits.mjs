...
fs.writeFileSync('edits/batch-C01-plotinus-dilthey.json', JSON.stringify({meta:{batch:'C01',
 title:'Поправка строя fix-описаний: принимающие системы от Плотина до Дильтея',
 spec:'descriptions-revision-spec.md', specRevision:4, target:'philosophy_graph.html',
 targetMd5:'db5db9e4c4070468f6e34502ce289703', created:'2026-08-11', layer:'cross-correction',
