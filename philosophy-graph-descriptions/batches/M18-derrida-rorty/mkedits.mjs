...
const PAIRS=[['nietzsche','derrida'],['freud','derrida'],['husserl','derrida'],
 ['bergson','derrida'],['heidegger','derrida'],['bataille','derrida'],['levinas','derrida'],
 ['quine','derrida'],['foucault','derrida'],['hegel','rorty'],['marx','rorty'],
 ['nietzsche','rorty'],['dewey','rorty'],['wittgenstein','rorty'],['heidegger','rorty'],
 ['quine','rorty'],['derrida','rorty']];
...
fs.writeFileSync('edits/batch-M18-derrida-rorty.json', JSON.stringify({meta:{batch:'M18',
 title:'Межсистемные связи: Деррида и Рорти — 17 пар, последний заход слоя',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'f7d804dabf4e65a3520bb2d6c70ab7d6',created:'2026-08-11',layer:'cross',
