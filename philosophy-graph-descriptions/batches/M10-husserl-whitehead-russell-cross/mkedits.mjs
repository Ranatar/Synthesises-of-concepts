...
const PAIRS=[['brentano','husserl'],['peirce','husserl'],['peirce','dewey'],
 ['nietzsche','bergson'],['frege','husserl'],['meinong','husserl'],['husserl','bergson'],
 ['husserl','dewey'],['aristotle','whitehead'],['plotinus','whitehead'],['spinoza','whitehead'],
 ['leibniz','whitehead'],['hegel','whitehead'],['nietzsche','whitehead'],['bergson','whitehead'],
 ['locke','russell'],['hume','russell'],['peirce','russell'],['frege','russell'],
 ['meinong','russell']];
...
fs.writeFileSync('edits/batch-M10-husserl-whitehead-russell-cross.json', JSON.stringify({meta:{batch:'M10',
 title:'Межсистемные связи: Гуссерль с современниками, Уайтхед, Рассел — 20 пар',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'76a88463e3b1e9b612849924a76f5589',created:'2026-08-10',layer:'cross',
