...
const PHILS = ['nietzsche', 'frege', 'meinong', 'freud'];
...
fs.writeFileSync('edits/batch-K10-nietzsche-freud.json', JSON.stringify({meta: {
  batch: 'K10',
  title: 'Описания концепций: Ницше, Фреге, Мейнонг, Фрейд',
