...
const PHILS = ['descartes', 'spinoza', 'locke'];
...
fs.writeFileSync('edits/batch-K05-descartes-locke.json', JSON.stringify({meta: {
  batch: 'K05',
  title: 'Описания концепций: Декарт, Спиноза, Локк',
