...
const PAIRS=[['hegel','comte'],['socrates','kierkegaard'],['augustine','kierkegaard'],
 ['rousseau','kierkegaard'],['hegel','kierkegaard'],['aristotle','marx'],['locke','marx'],
 ['rousseau','marx'],['fichte','marx'],['hegel','marx'],['comte','marx'],
 ['kant','dilthey'],['hegel','dilthey'],['comte','dilthey'],
 ['aristotle','brentano'],['aquinas','brentano'],['descartes','brentano'],['locke','brentano'],
 ['hume','brentano'],['kant','brentano'],['kant','peirce']];
...
fs.writeFileSync('edits/batch-M07-kierkegaard-marx-cross.json', JSON.stringify({meta:{batch:'M07',
 title:'Межсистемные связи: Кьеркегор, Маркс, Дильтей, Брентано, Пирс — 21 пара',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'b12599dd3394bcbb18cb50da6aff1f58',created:'2026-08-10',layer:'cross',
