...
//   node batches/F04-marx-husserl/mkedits.mjs
...
fs.writeFileSync('edits/batch-F04-marx-husserl.json', JSON.stringify({meta: {
  batch: 'F04',
  title: 'Описания философов: Маркс — Гуссерль',
