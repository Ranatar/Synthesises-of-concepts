...
const PAIRS=[['kierkegaard','bataille'],['marx','bataille'],['nietzsche','bataille'],
 ['freud','bataille'],['socrates','gadamer'],['plato','gadamer'],['aristotle','gadamer'],
 ['hegel','gadamer'],['dilthey','gadamer'],['husserl','gadamer'],['wittgenstein','gadamer'],
 ['heidegger','gadamer'],['descartes','lacan'],['hegel','lacan'],['kierkegaard','lacan'],
 ['frege','lacan'],['freud','lacan'],['wittgenstein','lacan'],['heidegger','lacan'],
 ['bataille','lacan'],['descartes','sartre'],['spinoza','sartre'],['kant','sartre'],
 ['fichte','sartre']];
...
fs.writeFileSync('edits/batch-M13-gadamer-lacan-cross.json', JSON.stringify({meta:{batch:'M13',
 title:'Межсистемные связи: Батай, Гадамер, Лакан, подступы к Сартру — 24 пары',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'c82b88e5d98cc77860c7e42b1039b04c',created:'2026-08-10',layer:'cross',
