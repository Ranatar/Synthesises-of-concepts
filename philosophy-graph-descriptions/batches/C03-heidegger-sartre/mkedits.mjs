...
fs.writeFileSync('edits/batch-C03-heidegger-sartre.json', JSON.stringify({meta:{batch:'C03',
 title:'Поправка строя fix-описаний: принимающие системы от Хайдеггера до Сартра',
 spec:'descriptions-revision-spec.md', specRevision:4, target:'philosophy_graph.html',
 targetMd5:'369f96fc37990b2fe81600bfcc8938fc', created:'2026-08-11', layer:'cross-correction',
