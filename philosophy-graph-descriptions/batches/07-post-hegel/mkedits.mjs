...
const HERE = byBirth.filter(p=>p.birth>=1775&&p.birth<=1818).map(p=>p.id);
...
const FL = JSON.parse(fs.readFileSync('batch07-flags.json','utf8'));
...
fs.writeFileSync('edits/batch-07-post-hegel.json', JSON.stringify({meta:{batch:'07',
  title:'Внутрисистемные связи: Шеллинг, Шопенгауэр, Конт, Кьеркегор, Маркс',
  spec:'descriptions-revision-spec.md',specRevision:3,target:'philosophy_graph.html',
  targetMd5:'dd00d1e6840e20e3274be945789229af',created:'2026-08-09',layer:'inner',
