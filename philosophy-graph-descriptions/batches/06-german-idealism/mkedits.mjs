...
const HERE = byBirth.filter(p=>p.birth>=1724&&p.birth<=1770).map(p=>p.id);
...
const FL = JSON.parse(fs.readFileSync('batch06-flags.json','utf8'));
...
fs.writeFileSync('edits/batch-06-german-idealism.json', JSON.stringify({meta:{batch:'06',
  title:'Внутрисистемные связи: Кант, Фихте, Гегель',
  spec:'descriptions-revision-spec.md',specRevision:3,target:'philosophy_graph.html',
  targetMd5:'5f5d95534b6bf34df85d27a3d77e06a4',created:'2026-08-09',layer:'inner',
