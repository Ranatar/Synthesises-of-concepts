...
const PAIRS=[['husserl','russell'],['bergson','russell'],['kant','cassirer'],
 ['hegel','cassirer'],['nietzsche','cassirer'],['husserl','cassirer'],['bergson','cassirer'],
 ['parmenides','heidegger'],['plato','heidegger'],['aristotle','wittgenstein'],
 ['aristotle','heidegger'],['augustine','wittgenstein'],['augustine','heidegger'],
 ['bacon','wittgenstein'],['descartes','wittgenstein'],['leibniz','wittgenstein'],
 ['kant','wittgenstein'],['kant','heidegger'],['hegel','heidegger'],['schelling','heidegger'],
 ['schopenhauer','wittgenstein'],['kierkegaard','heidegger'],['dilthey','heidegger'],
 ['brentano','heidegger'],['peirce','wittgenstein'],['peirce','heidegger'],
...
fs.writeFileSync('edits/batch-M11-cassirer-wittgenstein-heidegger-cross.json', JSON.stringify({meta:{batch:'M11',
 title:'Межсистемные связи: Кассирер, Витгенштейн, Хайдеггер — 27 пар',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'9ea555827299268d74ed4906352563f2',created:'2026-08-10',layer:'cross',
