...
const PAIRS=[['bergson','levinas'],['wittgenstein','levinas'],['heidegger','levinas'],
 ['bataille','levinas'],['sartre','levinas'],['hegel','quine'],['frege','quine'],
 ['freud','merleau_ponty'],['husserl','merleau_ponty'],['bergson','merleau_ponty'],
 ['wittgenstein','merleau_ponty'],['wittgenstein','quine'],['heidegger','merleau_ponty'],
 ['heidegger','quine'],['carnap','quine'],['lacan','merleau_ponty'],['sartre','merleau_ponty'],
 ['heraclitus','deleuze'],['parmenides','deleuze'],['plato','deleuze'],['aristotle','deleuze'],
 ['duns_scotus','deleuze'],['descartes','deleuze']];
...
fs.writeFileSync('edits/batch-M15-levinas-merleau-quine.json', JSON.stringify({meta:{batch:'M15',
 title:'Межсистемные связи: Левинас, Мерло-Понти, Куайн, подступы к Делёзу — 23 пары',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'7d289b3a595a2f5f632c65c4c01cadda',created:'2026-08-11',layer:'cross',
