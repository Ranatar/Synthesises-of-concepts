...
const PHILS = ['marx', 'dilthey', 'brentano', 'peirce'];
...
fs.writeFileSync('edits/batch-K09-marx-peirce.json', JSON.stringify({meta: {
  batch: 'K09',
  title: 'Описания концепций: Маркс, Дильтей, Брентано, Пирс',
