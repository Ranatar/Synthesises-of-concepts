...
const PHILS = ['gadamer', 'lacan', 'sartre', 'levinas'];
...
fs.writeFileSync('edits/batch-K14-gadamer-levinas.json', JSON.stringify({meta: {
  batch: 'K14',
  title: 'Описания концепций: Гадамер, Лакан, Сартр, Левинас',
