...
const PAIRS=[['spinoza','deleuze'],['leibniz','deleuze'],['hume','deleuze'],
 ['kant','deleuze'],['hegel','deleuze'],['marx','deleuze'],['peirce','deleuze'],
 ['nietzsche','deleuze'],['freud','deleuze'],['bergson','deleuze'],['whitehead','deleuze'],
 ['cassirer','deleuze'],['heidegger','deleuze'],['lacan','deleuze'],['sartre','deleuze'],
 ['levinas','deleuze']];
...
fs.writeFileSync('edits/batch-M16-deleuze-cross.json', JSON.stringify({meta:{batch:'M16',
 title:'Межсистемные связи: Делёз — 16 пар',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'c8999194e5cf1fe608244f62231f2db2',created:'2026-08-11',layer:'cross',
