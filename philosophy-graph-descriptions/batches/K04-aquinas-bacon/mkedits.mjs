...
const PHILS = ['aquinas', 'duns_scotus', 'cusanus', 'bacon'];
...
fs.writeFileSync('edits/batch-K04-aquinas-bacon.json', JSON.stringify({meta: {
  batch: 'K04',
  title: 'Описания концепций: Фома Аквинский, Дунс Скот, Николай Кузанский, Бэкон',
