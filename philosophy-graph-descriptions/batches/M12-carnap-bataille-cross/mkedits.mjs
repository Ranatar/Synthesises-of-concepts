...
const PAIRS=[['nietzsche','heidegger'],['frege','wittgenstein'],['husserl','wittgenstein'],
 ['husserl','heidegger'],['bergson','heidegger'],['dewey','wittgenstein'],['dewey','heidegger'],
 ['russell','wittgenstein'],['russell','heidegger'],['cassirer','wittgenstein'],
 ['cassirer','heidegger'],['wittgenstein','heidegger'],['frege','carnap'],['husserl','carnap'],
 ['russell','carnap'],['wittgenstein','carnap'],['heidegger','carnap'],['hegel','bataille'],
 ['schopenhauer','bataille']];
...
fs.writeFileSync('edits/batch-M12-carnap-bataille-cross.json', JSON.stringify({meta:{batch:'M12',
 title:'Межсистемные связи: Хайдеггер и Витгенштейн с современниками, Карнап, Батай — 19 пар',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'73891d14f1eda24c7e6ce31d131d2a30',created:'2026-08-10',layer:'cross',
