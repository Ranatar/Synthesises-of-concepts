...
const PHILS = ['leibniz', 'berkeley', 'hume', 'rousseau'];
...
fs.writeFileSync('edits/batch-K06-leibniz-rousseau.json', JSON.stringify({meta: {
  batch: 'K06',
  title: 'Описания концепций: Лейбниц, Беркли, Юм, Руссо',
