...
const PAIRS=[['aristotle','epicurus'],['epicurus','marcus_aurelius'],['plato','plotinus'],
 ['aristotle','plotinus'],['epicurus','plotinus'],['marcus_aurelius','plotinus'],
...
fs.writeFileSync('edits/batch-M02-late-antiquity-cross.json', JSON.stringify({meta:{batch:'M02',
 title:'Межсистемные связи: поздняя античность и ранняя схоластика — 16 пар (Аристотель, Эпикур, Марк Аврелий, Плотин, Августин, Ансельм, Фома)',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'3c0142394729c5dd55b702650b769337',created:'2026-08-10',layer:'cross',
