...
const HERE = byBirth.filter(p=>p.birth>=1033&&p.birth<=1596).map(p=>p.id);
...
const FL = JSON.parse(fs.readFileSync('batch03-flags.json','utf8'));
...
fs.writeFileSync('edits/batch-03-scholastics.json', JSON.stringify({meta:{batch:'03',
  title:'Внутрисистемные связи: Ансельм, Фома, Дунс Скот, Кузанский, Бэкон, Декарт',
  spec:'descriptions-revision-spec.md',specRevision:3,target:'philosophy_graph.html',
  targetMd5:'2d1e839b370901454aac0a7bc75993c9',created:'2026-08-09',layer:'inner',
