...
const PAIRS=[['spinoza','hegel'],['locke','hegel'],['leibniz','hegel'],['kant','hegel'],
 ['fichte','hegel'],['plotinus','schelling'],['cusanus','schelling'],['spinoza','schelling'],
 ['leibniz','schelling'],['kant','schelling'],['fichte','schelling'],['hegel','schelling'],
 ['plato','schopenhauer'],['marcus_aurelius','schopenhauer'],['leibniz','schopenhauer'],
 ['rousseau','schopenhauer'],['kant','schopenhauer'],['hegel','schopenhauer'],
 ['bacon','comte'],['kant','comte']];
...
fs.writeFileSync('edits/batch-M06-idealism-schopenhauer-cross.json', JSON.stringify({meta:{batch:'M06',
 title:'Межсистемные связи: завершение немецкого идеализма, Шеллинг, Шопенгауэр, Конт — 20 пар',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'d4e64ab16a5ae5a98ac12328c955e353',created:'2026-08-10',layer:'cross',
