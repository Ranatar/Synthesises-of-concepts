...
const PHILS = ['merleau_ponty', 'quine', 'deleuze'];
...
fs.writeFileSync('edits/batch-K15-merleau-deleuze.json', JSON.stringify({meta: {
  batch: 'K15',
  title: 'Описания концепций: Мерло-Понти, Куайн, Делёз',
