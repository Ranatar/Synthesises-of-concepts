...
const PAIRS=[['anselm','leibniz'],['duns_scotus','leibniz'],['descartes','leibniz'],
 ['spinoza','leibniz'],['locke','leibniz'],['descartes','berkeley'],['locke','berkeley'],
 ['leibniz','berkeley'],['aristotle','hume'],['aquinas','hume'],['bacon','hume'],
 ['descartes','hume'],['locke','hume'],['berkeley','hume'],['locke','rousseau'],
 ['pythagoras','kant'],['plato','kant'],['aristotle','kant'],['marcus_aurelius','kant'],
 ['augustine','kant'],['anselm','kant'],['aquinas','kant'],['duns_scotus','kant'],
 ['cusanus','kant'],['descartes','kant'],['spinoza','kant']];
...
fs.writeFileSync('edits/batch-M04-empiricism-kant-cross.json', JSON.stringify({meta:{batch:'M04',
 title:'Межсистемные связи: рационализм, эмпиризм и подступы к Канту — 26 пар (Лейбниц, Беркли, Юм, Руссо, Кант)',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'5a8eacc0f50db10ead817486c5823088',created:'2026-08-10',layer:'cross',
