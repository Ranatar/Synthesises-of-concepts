...
const PHILS = ['husserl', 'bergson', 'dewey'];
...
fs.writeFileSync('edits/batch-K11-husserl-dewey.json', JSON.stringify({meta: {
  batch: 'K11',
  title: 'Описания концепций: Гуссерль, Бергсон, Дьюи',
