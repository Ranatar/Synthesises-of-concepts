...
const PHILS = ['pythagoras', 'heraclitus', 'parmenides', 'socrates'];
...
fs.writeFileSync('edits/batch-K01-presocratics.json', JSON.stringify({meta: {
  batch: 'K01',
  title: 'Описания концепций: Пифагор, Гераклит, Парменид, Сократ',
