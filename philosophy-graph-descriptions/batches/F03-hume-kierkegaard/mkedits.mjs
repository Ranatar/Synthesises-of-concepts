...
//   node batches/F03-hume-kierkegaard/mkedits.mjs
...
fs.writeFileSync('edits/batch-F03-hume-kierkegaard.json', JSON.stringify({meta: {
  batch: 'F03',
  title: 'Описания философов: Юм — Кьеркегор',
