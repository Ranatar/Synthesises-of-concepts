...
const PAIRS=[['hegel','peirce'],['heraclitus','nietzsche'],['plato','nietzsche'],
 ['epicurus','nietzsche'],['marcus_aurelius','nietzsche'],['aquinas','nietzsche'],
 ['duns_scotus','nietzsche'],['spinoza','nietzsche'],['rousseau','nietzsche'],
 ['kant','nietzsche'],['hegel','nietzsche'],['schelling','nietzsche'],
 ['schopenhauer','nietzsche'],['comte','nietzsche'],['kierkegaard','nietzsche'],
 ['marx','nietzsche'],['dilthey','nietzsche'],['leibniz','frege'],['hume','frege'],
 ['kant','frege'],['brentano','meinong'],['rousseau','freud']];
...
fs.writeFileSync('edits/batch-M08-nietzsche-cross.json', JSON.stringify({meta:{batch:'M08',
 title:'Межсистемные связи: Ницше (шестнадцать пар), Фреге, Мейнонг, Фрейд — 22 пары',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'8f0ddb0f37f56bc967eea23072aa4034',created:'2026-08-10',layer:'cross',
