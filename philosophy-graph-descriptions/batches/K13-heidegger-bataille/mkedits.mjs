...
const PHILS = ['heidegger', 'carnap', 'bataille'];
...
fs.writeFileSync('edits/batch-K13-heidegger-bataille.json', JSON.stringify({meta: {
  batch: 'K13',
  title: 'Описания концепций: Хайдеггер, Карнап, Батай',
