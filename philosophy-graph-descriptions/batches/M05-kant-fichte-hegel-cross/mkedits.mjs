...
const PAIRS=[['locke','kant'],['leibniz','kant'],['berkeley','kant'],['hume','kant'],
 ['rousseau','kant'],['aristotle','fichte'],['cusanus','fichte'],['descartes','fichte'],
 ['spinoza','fichte'],['leibniz','fichte'],['rousseau','fichte'],['kant','fichte'],
 ['heraclitus','hegel'],['plato','hegel'],['aristotle','hegel'],['plotinus','hegel'],
 ['anselm','hegel'],['cusanus','hegel']];
...
fs.writeFileSync('edits/batch-M05-kant-fichte-hegel-cross.json', JSON.stringify({meta:{batch:'M05',
 title:'Межсистемные связи: наследство Канта, Фихте и подступы к Гегелю — 18 пар',
 spec:'descriptions-revision-spec.md',specRevision:4,target:'philosophy_graph.html',
 targetMd5:'683ab60ee744d915c9cfbf338b08c8c5',created:'2026-08-10',layer:'cross',
