...
const PHILS = ['epicurus', 'marcus_aurelius', 'plotinus', 'augustine', 'anselm'];
...
fs.writeFileSync('edits/batch-K03-epicurus-anselm.json', JSON.stringify({meta: {
  batch: 'K03',
  title: 'Описания концепций: Эпикур, Марк Аврелий, Плотин, Августин, Ансельм',
