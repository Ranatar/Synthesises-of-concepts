...
const HERE = byBirth.filter(p=>p.birth>=1646&&p.birth<=1712).map(p=>p.id);
...
const FL = JSON.parse(fs.readFileSync('batch05-flags.json','utf8'));
...
fs.writeFileSync('edits/batch-05-leibniz-rousseau.json', JSON.stringify({meta:{batch:'05',
  title:'Внутрисистемные связи: Лейбниц, Беркли, Юм, Руссо',
  spec:'descriptions-revision-spec.md',specRevision:3,target:'philosophy_graph.html',
  targetMd5:'2ec6fc80113f4b7c433a94e1b6477e40',created:'2026-08-09',layer:'inner',
