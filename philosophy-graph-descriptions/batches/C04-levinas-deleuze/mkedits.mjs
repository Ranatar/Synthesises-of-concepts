...
fs.writeFileSync('edits/batch-C04-levinas-deleuze.json', JSON.stringify({meta:{batch:'C04',
 title:'Поправка строя fix-описаний: принимающие системы Левинас, Мерло-Понти, Куайн, Делёз',
 spec:'descriptions-revision-spec.md', specRevision:4, target:'philosophy_graph.html',
 targetMd5:'1eba141e2a74b420fdf2d6eaed0f2799', created:'2026-08-11', layer:'cross-correction',
